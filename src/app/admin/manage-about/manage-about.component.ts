  ...
  @ViewChild('callDeleteDailog') callDelete!:TemplateRef<any>
   unvisible=false;
    ...
    ngOnInit(): void {
      ...
      console.log(this.generalService.allabout);
    ...
    UploadFile(file:any){
      ...
      this.adminService.uploadAttachmentAbout(formData);
    ...
    //  this.createForm.controls['cat_Id'].value:Number;
      console.log(this.createForm.value);
      this.adminService.createAbout(this.createForm.value);
...
image:new FormControl(),
    ...
    updateData(){
      ...
      this.adminService.updateabout(this.updateForm.value);
      ...
      dialogRef.afterClosed().subscribe((result)=>{
        if(result!=undefined)
        {
          if(result=='yes')
          {
            ...
            this.adminService.deleteabout(id);
          }
